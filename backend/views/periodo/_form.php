...
<div class="periodo-form">
    ...
    <?= $form->field($model, 'PERIODO')->textInput(['maxlength' => 9, 'oninput' => 'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);',  'placeholder'=>'Ingrese el periodo lectivo. Ejemplo: 2023-2024']) ?>
